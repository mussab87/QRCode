    ...
    public static class ObjectXMLSerializer<T> where T : class // Specify that T must be a class.
    {
        ...
        public static T Load(string path, SerializedFormat serializedFormat)
        {
            ...
            switch (serializedFormat)
            {
                ...
                case SerializedFormat.XmlString:
        ...
        public static T Load(XmlNode xml)
        {
            XmlSerializer serializer = CreateXmlSerializer(null);
            TextReader reader = CreateTextReader(xml);
        ...
        public static string Save(T obj,Type[] extraTypes)
        {
            System.Text.StringBuilder builder = new System.Text.StringBuilder();
            TextWriter writer = new StringWriter(builder);
        ...
        private static TextReader CreateTextReader(XmlNode node)
        {
