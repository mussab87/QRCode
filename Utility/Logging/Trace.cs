...
namespace Utility.Core.Logging
{
    ...
    public sealed class Trace
    {
        ...
        static MethodBase GetCallingMethod()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < st.FrameCount; ++i)
                {
                    ...
                    if (mb.DeclaringType.FullName != typeof(Trace).FullName && mb.DeclaringType.FullName != "Utility.Core.Logging.Trace")
                    {
                        break;
                    }
                }
        ...
        public static void WriteException(Exception e, string additionalMessage)
        {
            ...
            {
                EventLogger.WriteLog(e2, "My Clinic");
            }
        }
    }
}